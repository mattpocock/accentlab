    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'BROWSER_JS_DISABLED':
                return __('JavaScript is turned off in your browser. The form may not work properly.', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_WORDPRESS_DEFAULT_EMAIL_REQUIRED_MESSAGE':
             ...
             case 'LABEL_EMAIL_HANDLER':
               ...
               case 'HELP_OPTIONS_ENABLE_SMTP':
                return __('Use an external SMTP (Google, Yahoo! etc) instead of local mail server','custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_HIDE_TOOLBAR':
                return __('Hides the top WordPress admin bar for logged in users.', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FORM_TITLE':
                return __("Name of your form.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_LABEL':
                return __("Label of the field as it appears on forms and inside user accounts. This does not apply to fields without labels like Shortcode field.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_PRICE_FIELD':
                return __("Select the product created in &quot;Products&quot; section of RegistrationMagic.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_PYMNT_CURRENCY':
                return __("Default Currency for accepting payments. Usually, this will be default currency in your PayPal account. Please make sure currency you select is supported by PayPal. Not all currencies work well with PayPal as payment processor. ", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_PRICE_FIELD_LABEL':
                return __("For your reference only. This name will be visible when you will add product in a form. If you wish to show this name on the form, make sure while adding this product to a form you enter same field label as the product name.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_GEN_PROGRESS_BAR':
                return __("Shows form filling status above the form when Limits are turned on. For example, 2 out 50 registrations complete or 2 days to go before registration ends.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_HELP_TEXT':
                return __("This is displayed inside a fade-in box to the user when he/ she brings cursor above a field. The box disappears as soon as the cursor moves away from the field.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'UPLOAD_XML_HELP':
                return __("Upload the backup Rmagic.xml file you had exported earlier, to import all the form data.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_LABEL_IS_FIELD_EDITABLE':
                return __("If you have set up a front-end for your users and want them to login and edit the form submission once they have filled and sent the form, you must turn this on.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SHOW_TOTAL_PRICE' :
                return __('Enables a real-time display of total amount when you have multiple products added to the form.', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'LABEL_SELECT_PRICING_TYPE':
                return __('Select Product Pricing Type', 'custom-registration-form-builder-with-submission-manager');

            case 'LABEL_PRODUCT_NAME':
                return __('Product Name', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_SHOW_ON_FORM':
                return __("Display price on the form while user fills it. If turned off, user will be directly taken to checkout.", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_ADD_FIELD_IS_UNIQUE':
                return __("Mark this field as unique. No two users can submit same value for this field. Any subsequent attempt for submission with duplicate value with show a message.", 'custom-registration-form-builder-with-submission-manager');

            case 'LABEL_IS_UNIQUE':
                return __('Is Unique', 'custom-registration-form-builder-with-submission-manager');

            case 'LABEL_SUB_LIMIT_IND_USER':
                return __('Form submission limit for a user', 'custom-registration-form-builder-with-submission-manager');

            case 'HELP_SUB_LIMIT_IND_USER':
                return __('Limits how many times a form can be submitted by same user. Set it to zero(0) to disable this feature.', 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_GEN_REDIRECT_ADMIN_TO_DASH':
                return __("If enabled, admin users will always be redirected to admin dashboard irrespective of page/url selected above", 'custom-registration-form-builder-with-submission-manager');
            ...
            case 'NOTE_DEFAULT_FORM':
                return __("To make a form Default WordPress Registration form, make sure it is configured to create WordPress User accounts on submission.", 'registrationmagic-gold');
            ...
            case 'HELP_WIDGET_YT_AUTOPLAY':  
             ...
             case 'HELP_ADD_FIELD_MULTI_LINE_TYPE':
                 return __("Allows user to add extra text area boxes to the form for submitting different values. Useful where a field requires multiple user input values.",'custom-registration-form-builder-with-submission-manager');
            ...
            case 'HELP_OPTIONS_AR_US_FROM_EMAIL':
                 return __("The sender's email address in the message header that the user will receive.",'custom-registration-form-builder-with-submission-manager');
            
            case 'HELP_OPTIONS_AR_AD_FROM_EMAIL':
                 return __("The sender's email address in the message header that the admin will receive. You can also set this dynamically to the email of the user submitting the form by using tag {{useremail}}. This can be useful if you wish to forward submissions to a helpdesk or ticketing software.",'custom-registration-form-builder-with-submission-manager');
